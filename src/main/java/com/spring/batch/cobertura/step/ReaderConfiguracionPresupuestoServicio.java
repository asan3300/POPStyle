...
public class ReaderConfiguracionPresupuestoServicio implements ItemReader<List<Object[]>> {
	...
	public List<Object[]> read() throws Exception, UnexpectedInputException, ParseException, NonTransientResourceException {
		...
		List<Object[]> configuracionPresupuestoServicio = portafolioService.findConfiguracionPresupuestoServicio();
		readCount++;
